local c = require("venomous.palette")
...
if vim.g.venomous_italic_keywords then
	italic_keywords = true
end

if vim.g.venomous_italic_functions then
	italic_functions = true
end

if vim.g.venomous_italic_comments then
	italic_comments = true
end

if vim.g.venomous_italic_loops then
	italic_loops = true
end

if vim.g.venomous_italic_conditionals then
...
theme.set_highlights = function()
	...
	hl(0, "CursorLineNr", { fg = c.active_green, bg = "NONE", bold = true })
